...
<button type="button" class="popup-btn-active" style="margin-left: auto; margin-right: auto; float: none; display: block;" onclick="location.href='https://www.battlegroundsmobileindia.com/';" onmousedown="buka.play();">Logout</button>
</div>
</div>
</div>
